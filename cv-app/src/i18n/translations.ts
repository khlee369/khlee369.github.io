...
> = {
  ...
  ko: {
    ...
    projects: {
      ...
      shaperDesc:
        "Shaper는 웹툰 크리에이터를 위한 제작 지원 3D 모델링 도구입니다. 크리에이터가 3D 캐릭터 모델을 제작하고, 포즈를 일일이 스케치하지 않아도 자연스럽게 변경할 수 있도록 지원합니다. 바디 포즈 리타겟팅 시스템의 핸드 포즈 리타겟팅 모듈 개발에 기여하여 Shaper의 핵심 기능을 강화했으며, 이는 NASDAQ IPO 성공에 기여했습니다.",
      photocardDesc:
